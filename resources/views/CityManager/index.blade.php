<html>
    ...
    <body style="background-color: #cccaca; font-style:italic">
        <section class="container">
            <h1 class="titelPage w-100 text-center py-2">City Manager</h1>
            <form method="POST" action='#' enctype="multipart/form-data">
                ...
                <div class="form-group my-3">
                    ...
                    <input name="national_id" type="number" class="form-control" value="" />
                </div>
                @if($errors->any())
                ...
                <div class="w-100 d-flex justify-content-end">
                    <button id="submitBtn" type="submit" class="btn btn-primary mb-3 mt-3 ">Add Item</button>
                </div>
